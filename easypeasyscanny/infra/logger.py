...
def get_logger(name: str) -> logging.Logger:
    ...
    fh = RotatingFileHandler(LOG_PATH, maxBytes=1_000_000, backupCount=3, encoding="utf-8"); fh.setFormatter(fmt_file)
    ch = logging.StreamHandler(); ch.setFormatter(fmt_console)
    root.handlers.clear(); root.addHandler(fh); root.addHandler(ch)
